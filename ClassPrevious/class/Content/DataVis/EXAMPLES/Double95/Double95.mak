...
!IF "$(CFG)" == ""
CFG=Double95 - Win32 Debug
!MESSAGE No configuration specified.  Defaulting to Double95 - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "Double95 - Win32 Release" && "$(CFG)" !=\
 "Double95 - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE on this makefile
!MESSAGE by defining the macro CFG on the command line.  For example:
!MESSAGE 
!MESSAGE NMAKE /f "Double95.mak" CFG="Double95 - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "Double95 - Win32 Release" (based on\
 "Win32 (x86) Console Application")
!MESSAGE "Double95 - Win32 Debug" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
ALL : "$(OUTDIR)\Double95.exe"

CLEAN : 
	-@erase "$(INTDIR)\double.obj"
	-@erase "$(OUTDIR)\Double95.exe"
...
CPP_PROJ=/nologo /ML /W1 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_CONSOLE"\
 /Fp"$(INTDIR)/Double95.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=.\.
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/Double95.bsc" 
BSC32_SBRS= \
...
LINK32_FLAGS=opengl32.lib glu32.lib glut.lib kernel32.lib user32.lib gdi32.lib\
 ...
 /pdb:"$(OUTDIR)/Double95.pdb" /machine:I386 /out:"$(OUTDIR)/Double95.exe" 
LINK32_OBJS= \
	"$(INTDIR)\double.obj"

"$(OUTDIR)\Double95.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<

!ELSEIF  "$(CFG)" == "Double95 - Win32 Debug"
...
CLEAN : 
	...
	-@erase "$(OUTDIR)\Double95.exe"
	-@erase "$(OUTDIR)\Double95.ilk"
	-@erase "$(OUTDIR)\Double95.pdb"
...
CPP_PROJ=/nologo /MLd /W1 /Gm /GX /Zi /Od /D "WIN32" /D "_DEBUG" /D "_CONSOLE"\
 /Fp"$(INTDIR)/Double95.pch" /YX /Fo"$(INTDIR)/" /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Debug/
CPP_SBRS=.\.
...
LINK32_FLAGS=opengl32.lib glu32.lib glut.lib kernel32.lib user32.lib gdi32.lib\
 ...
 /pdb:"$(OUTDIR)/Double95.pdb" /debug /machine:I386\
 /out:"$(OUTDIR)/Double95.exe" 
LINK32_OBJS= \
	"$(INTDIR)\double.obj"
...
# Name "Double95 - Win32 Release"
# Name "Double95 - Win32 Debug"
...
SOURCE="\FrontPage Webs\Content\DataVis\examples\double.c"
DEP_CPP_DOUBL=\
	{$(INCLUDE)}"\GL\gl.h"\
	{$(INCLUDE)}"\GL\glu.h"\
	{$(INCLUDE)}"\GL\glut.h"\
...
"$(INTDIR)\double.obj" : $(SOURCE) $(DEP_CPP_DOUBL) "$(INTDIR)"
   $(CPP) $(CPP_PROJ) $(SOURCE)
