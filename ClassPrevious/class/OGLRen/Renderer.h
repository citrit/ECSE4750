...
class Renderer: public ParentObject {
  ...
  public:
    ...
    enum RenderType { TESSPOLYGON, POLYGON, LINE, TRIANGLE, LINE_LOOP, POINT, POLYLINE };
    ...
    virtual void BeginDL(unsigned int&  dlnum) = 0;
    virtual void EndDraw() = 0;
    virtual void EndDL() = 0;
    virtual void Vertex(double x, double y, double z = 0) = 0;
	virtual void DrawDisplayList(unsigned int dlnum) = 0;
	virtual void PushMatrix() = 0;
	virtual void PopMatrix() = 0;
	virtual void SetOrientation(float *orient, float *scale, PointType *pos) = 0;
