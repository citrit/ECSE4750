...
class Hw2 extends Frame
{
	...
	public static void main(String argv[]) throws Exception
	{
		...
		PointCell poCell = new PointCell();
		...
		try
		{
			ReadFile r = new ReadFile(argv[0]);
		
		
			/* Start reading data from example.dat */
			while(!ReadFile.end_of_file)
			{
				r.readLine();
				if(r.line == null)
					break;
		...
		System.out.println("	To Change the camera postion:");
		System.out.println("		'>' -> increase the x value");
		System.out.println("		'<' -> decrease the x value");
		System.out.println("		'^' -> increase the y value");
		System.out.println("		'v' -> decrease the y value");
		System.out.println("		'z' -> increase the y value");
		System.out.println("		'Z' -> decrease the y value");
		System.out.println("	To rotate the object, press 'h', 'j', 'k', 'l'");
		System.out.println("	To zoom object press '-' or '+'");
