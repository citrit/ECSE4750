...
public interface Renderer
{
	...
	/** Get the current active Camera, currently only one camera supported */
	...
	public abstract void endDL(int dl);
	...
	public abstract void setOrientation(float rotations[], float scale[], PointType pos);
	...
	public abstract void setPointSize(float s);
}
