...
//	public OGLCamera(){ }
//
//	public OGLCamera(float fX, float fY, float fZ, float tX, float tY, float tZ){
//		System.out.println(fX + " | " + fY + " | " +fZ + " | " +tX + " | " +tY + " | " +tZ);
//		
//		from = new PointType(fX, fY, 5);
//		to = new PointType(tX, tY, 0);
//		up = new PointType();
//		up.y = 1;
//	}
	...
	public void init()
	{
		gl.matrixMode(GL.PROJECTION);
		gl.loadIdentity();
		gl.perspective(eyeAngle, 1.0F*width/height, clipRange[0], clipRange[1]);
		gl.lookAt(from.x, from.y, from.z, to.x, to.y, to.z, up.x, up.y, up.z);
	}
}
