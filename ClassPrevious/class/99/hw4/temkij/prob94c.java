...
public class prob94c extends Frame
{
	...
	public static void main( String args[] )
    {
       ...
       vtkWarpVector sonic = new vtkWarpVector();
        //sonic.SetSource(probe.GetOutput());
       sonic.SetInput(pl3d.GetOutput());
       sonic.SetScaleFactor(0.005F);
       ...
       outTpd1.SetInput(tpd1.GetOutput());
        ...
        probe.SetSource(sonic.GetOutput());
        ...
        ff =sonic.GetOutput().GetScalarRange();
        ...
        contourMapper.SetScalarRange(sonic.GetOutput().GetScalarRange());
