...
public class prob94b extends Frame
{
	...
	public static void main( String args[] )
    {
       ...
       threshold.SetInput(pl3d.GetOutput());
       threshold.ThresholdByUpper(275);

       vtkPlaneSource plane = new vtkPlaneSource();
       plane.SetResolution(5,5);

       vtkPlaneSource splane = new vtkPlaneSource();
       splane.SetResolution(5,5);
       ...
       vtkTransformPolyDataFilter stpd1 = new vtkTransformPolyDataFilter();
       stpd1.SetInput(splane.GetOutput());
       stpd1.SetTransform(transP1);
       ...
       outTpd1.SetInput(tpd1.GetOutput());
        ...
        probe.SetInput(tpd3.GetOutput());
        probe.SetSource(pl3d.GetOutput());

        vtkProbeFilter sprobe = new vtkProbeFilter();
        sprobe.SetInput(stpd1.GetOutput());
        sprobe.SetSource(pl3d.GetOutput());
        //vtkThresholdPoints threshold = new vtkThresholdPoints();
        //threshold.SetInput(pl3d.GetOutput());
        //threshold.ThresholdByUpper(275);
        vtkPointSource source = new vtkPointSource();
        source.SetNumberOfPoints(250);
        source.SetCenter(50,50,0);
        source.SetRadius(5.0);

        vtkStreamLine sonic = new vtkStreamLine();
        sonic.SetSource(probe.GetOutput());
        sonic.SetInput(pl3d.GetOutput());
        sonic.SetMaximumPropagationTime(100.0F);
        sonic.SetIntegrationStepLength(0.2F);
        sonic.SpeedScalarsOn();
        sonic.SetTerminalSpeed(0.1F);
        ...
        sonicMapper.SetInput(tubes.GetOutput());
        ...
        panel.getRenderer().AddActor(sonicActor);
