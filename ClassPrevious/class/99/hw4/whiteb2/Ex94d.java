// Bryan Whitehead Hw4
// Modified from code on VTK Disk
import vtk.*;
import java.awt.*;
...
public class Ex94d extends Frame
{
	...
	public static void main ( String args[] )
	{
		...
		vectornorm.SetInput(probe.GetOutput());
		vectornorm.NormalizeOn();
		
		vtkDataSetMapper vectornormmapper = new vtkDataSetMapper();
		vectornormmapper.SetInput(vectornorm.GetOutput());

		vtkActor planeActor = new vtkActor();
	    	planeActor.SetMapper(vectornormmapper);
