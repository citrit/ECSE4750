...
public class Ex94d extends Frame
{
	...
	public static void main ( String args[] )
	{
		...
		/* VectorNorm Object */
		vtkVectorNorm norm = new vtkVectorNorm();
		norm.SetInput(probe.GetOutput());
		/* turn on the normalize function */
		norm.SetNormalize(1);

		vtkDataSetMapper normMapper = new vtkDataSetMapper();
		normMapper.SetInput(norm.GetOutput());
		normMapper.ScalarVisibilityOn();

		vtkActor planeActor = new vtkActor();
	    planeActor.SetMapper(normMapper);
