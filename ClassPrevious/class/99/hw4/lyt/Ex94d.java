/* Decompiled by Mocha from Ex94d.class */
/* Originally compiled from Ex94d.java */

import java.awt.*;
import vtk.*;
import java.io.PrintStream;

public class Ex94d extends Frame
{
    ...
    public static void main(String astring[])
    {
        ...
        vtkVectorNorm VtkVectorNorm = new vtkVectorNorm();
        VtkVectorNorm.SetInput(VtkProbeFilter.GetOutput());
        VtkVectorNorm.NormalizeOn();
        vtkDataSetMapper VtkDataSetMapper = new vtkDataSetMapper();
        VtkDataSetMapper.SetInput(VtkVectorNorm.GetOutput());
        ...
        ex94d.add("Center", VtkPanel);
        ex94d.pack();
        MenuBar menuBar = new MenuBar();
        Menu menu = new Menu("File");
        menu.add(new MenuItem("Exit"));
        menuBar.add(menu);
        ex94d.setMenuBar(menuBar);
        ex94d.show();
    }
}
