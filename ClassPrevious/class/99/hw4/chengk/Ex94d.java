...
public class Ex94d extends Frame
{
	...
	public static void main ( String args[] )
	{
		...
		vtkVectorNorm vectnorm = new vtkVectorNorm();   //use vectornorm instead of contourfilter
		vectnorm.SetInput(probe.GetOutput());
		vectnorm.SetNormalize(1);

		vtkDataSetMapper vectnormMapper = new vtkDataSetMapper();
		vectnormMapper.SetInput(vectnorm.GetOutput());
		vectnormMapper.ScalarVisibilityOn();

		vtkActor planeActor = new vtkActor();
		planeActor.SetMapper(vectnormMapper);
