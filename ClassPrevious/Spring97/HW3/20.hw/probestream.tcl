...
vtkPointSource seed1;
    seed1 SetRadius 2.;
    seed1 SetCenter 1.0 0.0 30.0;
    seed1 SetNumberOfPoints 35;

vtkPointSource seed2;
    seed2 SetRadius 1.;
    seed2 SetCenter 2.5 -1.0 25.0;
    seed2 SetNumberOfPoints 35;

vtkAppendPolyData seeds;
    seeds AddInput [seed1 GetOutput];
    seeds AddInput [seed2 GetOutput];

vtkStreamLine stream;
    stream SetInput [pl3d GetOutput];
    stream SetSource [seeds GetOutput];
    stream SetStepLength 0.005;
    stream SetMaximumPropagationTime 7.5;

vtkPolyMapper streamMapper;
    streamMapper SetInput [stream GetOutput];
    eval streamMapper SetScalarRange 0.15 0.5;
