...
vtkGeometryFilter pointgeom;
    pointgeom SetInput [probe GetOutput];

vtkWarpVector warp;
    warp SetInput [pointgeom GetOutput];
    warp SetScaleFactor 0.003;

vtkGeometryFilter warpgeom;
    warpgeom SetInput [warp GetOutput];

vtkCleanPolyData clean;
    clean SetInput [warpgeom GetOutput];
...
vtkDataSetMapper warpMapper;
    warpMapper SetInput [normals GetOutput];
    eval warpMapper SetScalarRange 0.15 0.75;
vtkActor planeActor;
