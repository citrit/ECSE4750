...
vtkVectorNorm vecnorm;
    vecnorm SetInput [probe GetOutput];
vecnorm SetNormalize 1

vtkDataSetMapper vecnormMapper;
vecnormMapper SetInput [vecnorm GetOutput];
vecnormMapper SetScalarRange -1 1

vtkActor planeActor;
    planeActor SetMapper vecnormMapper;
