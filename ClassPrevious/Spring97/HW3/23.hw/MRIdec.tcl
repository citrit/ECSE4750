...
#This has the decimation code in it too!
...
vtkTriangleFilter transform;
  transform SetInput [contour GetOutput];

vtkDecimate killer;
  killer SetInput [transform GetOutput];

vtkPolyMapper volMapper;
  volMapper SetInput [killer GetOutput];
