...
#Modified probcom.tcl code which now has a hedgehog filter after the 
#probe filter
...
vtkPLOT3DReader pl3d;
    pl3d SetXYZFilename "/campus/visualization/vtk/1.3/data/combxyz.bin"
    pl3d SetQFilename "/campus/visualization/vtk/1.3/data/combq.bin"
...
vtkHedgeHog hedge_fil;
    hedge_fil SetInput [probe GetOutput];
    hedge_fil SetScaleFactor 0.01
#    eval hedge_fil GenerateValues 50 [[pl3d GetOutput] GetScalarRange];

vtkPolyMapper hedgeMapper;
    hedgeMapper SetInput [hedge_fil GetOutput];
    eval hedgeMapper SetScalarRange [[pl3d GetOutput] GetScalarRange];
vtkActor planeActor;
