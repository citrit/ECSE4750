...
vtkHedgeHog FILTER;
    FILTER SetInput [probe GetOutput];
    FILTER SetScaleFactor .01

vtkPolyMapper FILTERMapper;
    FILTERMapper SetInput [FILTER GetOutput];
    eval FILTERMapper SetScalarRange [[pl3d GetOutput] GetScalarRange];
vtkActor planeActor;
    planeActor SetMapper FILTERMapper;
