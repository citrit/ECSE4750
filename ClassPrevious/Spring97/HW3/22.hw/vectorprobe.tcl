...
#Modified probecom.tcl code which now has a VectorNorm filter after the 
#probe filter
...
vtkAppendFilter argh;
argh AddInput [probe GetOutput];

vtkVectorNorm bleh;
bleh SetInput [argh GetOutput];
bleh NormalizeOn;

#vtkDataSetToPolyFilter contour;
#contour SetInput [bleh GetOutput];
#eval contour GenerateValues 50 [[pl3d GetOutput] GetScalarRange];


vtkDataSetMapper contourMapper;
contourMapper SetInput [bleh GetOutput];
