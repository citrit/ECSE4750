#Stephen Young
#Homework 3
#Modified probecom.tcl code which now has a warpVector filter after the 
#probe filter
...
#Throw in an append Filter
vtkAppendFilter growf;
growf AddInput [probe GetOutput];

#Feed the output of the append Filter into the warpVector
vtkWarpVector  warp;
warp SetInput [growf GetOutput];
warp SetScaleFactor 0.0075;
