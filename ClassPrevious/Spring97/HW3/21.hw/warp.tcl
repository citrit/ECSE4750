...
vtkWarpVector warp;
    warp SetInput [pl3d GetOutput];
    warp SetScaleFactor 0.05;

#vtkDataSetMapper outlineMapper;
#    outlineMapper SetInput [warp GetOutput];
#
...
vtkActor tpd2Actor;
    ...
    [tpd2Actor GetProperty] SetColor 0 1 0;
...
vtkProbeFilter probe;
    ...
    probe SetSource [warp GetOutput];
...
vtkDataSetMapper contourMapper;
    contourMapper SetInput [clean GetOutput];
    eval contourMapper SetScalarRange [[probe GetOutput] GetScalarRange];
vtkActor planeActor;
