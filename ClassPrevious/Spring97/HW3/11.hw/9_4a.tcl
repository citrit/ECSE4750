...
vtkHedgeHog hg;
    hg SetScaleFactor 0.01;
    hg SetInput [probe GetOutput];

vtkPolyMapper hgMapper;
    hgMapper SetInput [hg GetOutput];
    eval hgMapper SetScalarRange [[pl3d GetOutput] GetScalarRange];

vtkActor hgActor;
    hgActor SetMapper hgMapper;
 
vtkContourFilter contour;
    contour SetInput [probe GetOutput];
    eval contour GenerateValues 150 [[pl3d GetOutput] GetScalarRange];
