...
#vnorm requires an input of PointSet & returns PointSet
    vnorm SetInput [probe GetOutput];
    vnorm NormalizeOn;

vtkContourFilter contour;
    contour SetInput [vnorm GetOutput];
    eval contour GenerateValues 150 [[pl3d GetOutput] GetScalarRange];

vtkDataSetMapper normMapper;
    normMapper SetInput [contour GetOutput];
    eval normMapper SetScalarRange [[pl3d GetOutput] GetScalarRange];
