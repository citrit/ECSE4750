...
vtkContourFilter contour;
    contour SetInput [vectornorm GetOutput];
    eval contour GenerateValues 50 [[pl3d GetOutput] GetScalarRange];

# VectorNorm Mapper
vtkDataSetMapper vectornormMapper;
    vectornormMapper SetInput [contour GetOutput];
    eval vectornormMapper SetScalarRange [[pl3d GetOutput] GetScalarRange];

# VectorNorm Actor
vtkActor vectornormActor;
    vectornormActor SetMapper vectornormMapper;
