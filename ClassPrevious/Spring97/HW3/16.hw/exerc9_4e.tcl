...
vtkVectorDot vectordot;
    vectordot SetInput [probe GetOutput];
    eval contour GenerateValues 50 [[pl3d GetOutput] GetScalarRange];

# VectorDot Mapper
vtkDataSetMapper vectordotMapper;
    vectordotMapper SetInput [contour GetOutput];
    eval vectordotMapper SetScalarRange [[pl3d GetOutput] GetScalarRange];

# VectorDot Actor
vtkActor vectordotActor;
    vectordotActor SetMapper vectordotMapper;
