...
vtkVectorDot vectDot;
    vectDot SetInput [normals GetOutput];

vtkDataSetMapper vectMapper;
    vectMapper SetInput [vectDot GetOutput];
    eval vectMapper SetScalarRange [[pl3d GetOutput] GetScalarRange];

vtkActor planeActor;
    planeActor SetMapper vectMapper;
