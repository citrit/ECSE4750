# tcl file for Graphics Project 3, problem 9.4c
# John P Kozura
...
# here we want to affect the geometry with warp

vtkGeometryFilter geometry;
    geometry SetInput [probe GetOutput];
vtkWarpVector warp;
    warp SetInput [geometry GetOutput];
    warp SetScaleFactor 0.005;

vtkDataSetMapper wmapper;
    wmapper SetInput [warp GetOutput];
    eval wmapper SetScalarRange [[pl3d GetOutput] GetScalarRange];
vtkActor warpActor;
    warpActor SetMapper wmapper;
