...
vtkHedgeHog hedhog;
    hedhog SetScaleFactor 0.01;
    hedhog SetInput [probe GetOutput];
vtkPolyMapper hedhogMapper;
    hedhogMapper SetInput [hedhog GetOutput];
    eval hedhogMapper SetScalarRange [[pl3d GetOutput] GetScalarRange];
vtkActor hedhogActor;
    hedhogActor SetMapper hedhogMapper;
