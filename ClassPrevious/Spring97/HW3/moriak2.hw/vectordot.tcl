...
vtkVectorDot dot;
    dot SetInput [probe GetOutput];
    dot SetScalarRange -1.0 1.0;
    dot Update;
    #eval dot SetScalarRange [[pl3d GetOutput] GetScalarRange];
    # generate scalars from dot product of vectors and
    # normals (e.g., show displacement plot)

vtkDataSetMapper dotMapper;
    dotMapper SetInput [dot GetOutput];
    #eval dotMapper SetScalarRange [[pl3d GetOutput] GetScalarRange];
    dotMapper ScalarsVisibleOn;
vtkActor planeActor;
    planeActor SetMapper dotMapper;
