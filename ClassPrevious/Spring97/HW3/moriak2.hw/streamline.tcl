...
vtkPointSource points;
     points SetNumberOfPoints 200;
     points SetCenter 0.8 -12.2 0.03;
...
vtkStreamLine stream;
    ...
    stream SetIntegrationStepLength 0.02;
    stream SetStepLength 0.02;
    stream Update;
    # smaller values result in smoother streamlines, but greater number
    # of line primitives.

vtkPolyMapper contourMapper;
    contourMapper SetInput [stream GetOutput];
    contourMapper ScalarsVisibleOn;
