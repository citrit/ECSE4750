...
vtkHedgeHog hhog;
    ...
    hhog SetScaleFactor 0.008;
#    eval hedgehog SetScaleFactor [[pl3d GetOutput] GetScaleFactor];	


vtkPolyMapper hhogMapper;
    hhogMapper SetInput [hhog GetOutput];
    eval hhogMapper SetScalarRange [[pl3d GetOutput] GetScalarRange];

vtkActor planeActor;
    planeActor SetMapper hhogMapper;
